...
//        }
    ...
    private void createOder(String status) {
        ...
        showProgressDialog();
        UdriveRestClient.getClentInstance().createOder(map)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    private void finishOder() {
        showProgressDialog();
        UdriveRestClient.getClentInstance().completeTripOrder(orderNum)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    private void checkCar() {
        ...
        showProgressDialog();
        UdriveRestClient.getClentInstance().checkCar(carId, toPark.getId())
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
