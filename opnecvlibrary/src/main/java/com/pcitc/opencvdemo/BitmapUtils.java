...
public class BitmapUtils {
    ...
    public static Bitmap getZoomImage(Bitmap bitmap, double maxSize) {
        ...
        while (currentSize > maxSize) {
            ...
            Log.d(TAG,"bitmapSize:"+currentSize);
        }
        return bitmap;
    }
     ...
     * @return
     */
    public static boolean saveBitmapToFile(Bitmap bitmap,File path){
