...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void onEnterStartedState() {
        ...
        if (!connectCamera(getWidth(), getHeight())) {
            ...
            ad.setMessage(getResources().getString(R.string.no_camera_permission_message));
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if (canvas != null) {
                ...
                Bitmap outputBitmap1 = Bitmap.createBitmap(mCacheBitmap, 0, 0, mCacheBitmap.getWidth(), mCacheBitmap.getHeight(), matrix, true);
                Bitmap outputBitmap=outputBitmap1;

//                int squareLength=Math.min(width,height);
//                int startLenth=Math.max(width,height)-squareLength;
//                Bitmap outputBitmap=Bitmap.createBitmap(outputBitmap1,0,startLenth/2,squareLength,squareLength);
//                outputBitmap1.recycle();
//                if (mScale != 0) {
...
//                }
                ...
                Log.d("size","width="+canvas.getWidth());
                Log.d("size","height="+canvas.getHeight());

                Log.d("size","width="+outputBitmap.getWidth());
                Log.d("size","height="+outputBitmap.getHeight());

                Log.d("size","scale="+mScale);

                int left=(canvas.getWidth()-outputBitmap.getWidth())/2;
                int top=(canvas.getHeight()-outputBitmap.getHeight())/2;
...
//                int left= (canvas.getWidth()-outputBitmap.getWidth())/2;
//                int top= (canvas.getHeight()-outputBitmap.getHeight())/3;
