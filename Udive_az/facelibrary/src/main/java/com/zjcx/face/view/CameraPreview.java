...
import com.zjcx.face.listener.CaremaType;
import com.zjcx.face.listener.Delegate;
import com.zjcx.face.listener.FaceInterface;
import com.zjcx.face.listener.OnCaptureCallback;
import com.zjcx.face.listener.OnFrameListener;
import com.zjcx.face.util.Contants;
import com.zjcx.face.util.LogUtils;
...
//                    byte[] data2    = Bitmap2Bytes(bitmap);
    ...
    public void tackPicture(OnCaptureCallback onCaptureCallback){
        mCameraConfigurationManager.tackPicture(getCamera(),onCaptureCallback);
    }
    /**
     * 切换摄像头
     */
