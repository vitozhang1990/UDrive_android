...
//					RouteBusLineItem busline = busStep.getBusLines().get(0);
    ...
    public static Bitmap bitmapWithCenterText(Context context, int mipMapId, String pm_val) {
        return bitmapWithCenterText(context, mipMapId, pm_val, 16);
    }
     ...
     * @return
     */
    public static Bitmap bitmapWithCenterText(Context context, int mipMapId, String pm_val, int textSize) {
        ...
        textPaint.setTextSize(SizeUtils.sp2px(context, textSize));
